...
def get_file_path(instance, filename):
    ...
    return '/'.join(['pj_board/', ymd_path, uuid_name+extension])

# Create your models here.
class pj_post(models.Model):
    ...
    def delete(self, *args, **kargs):
        ...
        super(pj_post, self).delete(*args, **kargs)
    
    class Meta:
        db_table = 'pj_board_civ'
        verbose_name = 'pj_board_civ'
        verbose_name_plural = 'pj_board_civ'