...
def get_file_path(instance, filename):
    ...
    return '/'.join(['member_board_alum_MA_city/', ymd_path, uuid_name+extension])

# Create your models here.
class member_post_alum_MA_city(models.Model):
    ...
    def delete(self, *args, **kargs):
        ...
        super(member_post_alum_MA_city, self).delete(*args, **kargs)
