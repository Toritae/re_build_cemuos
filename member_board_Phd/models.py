...
class member_post_Phd(models.Model):
    ...
    def delete(self, *args, **kargs):
        ...
        super(member_post_Phd, self).delete(*args, **kargs)
    
    class Meta:
        db_table = 'member_board_Phd'
        verbose_name = 'member_board_Phd'
        verbose_name_plural = 'member_board_Phd'