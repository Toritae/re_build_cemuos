...
def get_file_path(instance, filename):
    ...
    return '/'.join(['member_board_alum_MA/', ymd_path, uuid_name+extension])

# Create your models here.
class member_post_alum_MA(models.Model):
    ...
    def delete(self, *args, **kargs):
        ...
        super(member_post_alum_MA, self).delete(*args, **kargs)
    
    class Meta:
        db_table = 'member_board_alum_MA'
        verbose_name = 'member_board_alum_MA'
        verbose_name_plural = 'member_board_alum_MA'